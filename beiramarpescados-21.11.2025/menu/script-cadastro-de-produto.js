...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnAdicionar.addEventListener('click', function() {
        ...
        if (!produtoNome || !dataEntrega || !quantidade || !valor) {
            alert('Por favor, preencha todos os campos: Nome do Produto, Data da Entrega, Quantidade e Valor.');
            return;
        }
    ...
    // Permitir adicionar produto ao pressionar Enter
    produtoInput.addEventListener('keypress', function(e) {
        if (e.key === 'Enter') {
            btnAdicionar.click();
        }
    });
